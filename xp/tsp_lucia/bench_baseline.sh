#!/bin/bash
#
#SBATCH --job-name=tsp_bench
#SBATCH --output=logs/tsp_bench_%A_%a.out  # stdout log for each array task
#SBATCH --error=logs/tsp_bench_%A_%a.err   # stderr log for each array task
#
...
# E.g. if your input file has 527 lines:
#SBATCH --array=0-116
#
