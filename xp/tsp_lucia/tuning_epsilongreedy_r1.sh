#!/bin/bash
#
#SBATCH --job-name=irace_tsp_epsilongreedy_r1
#SBATCH --output=logs/irace_tsp_epsilongreedy_r1.out  # stdout log for the task
#SBATCH --error=logs/irace_tsp_epsilongreedy_r1.err   # stderr log for the task
#
#SBATCH --ntasks=1
