...
output=`$launch_solver --problem tsp --input ${instance} --timeout ${timeout} --bandit ${bandit} --verbosity 0`
...
echo "$instance,$bandit,$timeout,$unroutedNodes,$travelLength,$solOverTime,$integralPrimalGap"
