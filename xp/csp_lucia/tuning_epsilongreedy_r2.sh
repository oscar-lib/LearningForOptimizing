#!/bin/bash
#
#SBATCH --job-name=irace_csp_epsilongreedy_r2
#SBATCH --output=logs/irace_csp_epsilongreedy_r2.out  # stdout log for the task
#SBATCH --error=logs/irace_csp_epsilongreedy_r2.err   # stderr log for the task
#
#SBATCH --ntasks=1
