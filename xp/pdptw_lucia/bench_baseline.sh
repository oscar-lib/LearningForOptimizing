#!/bin/bash
#
#SBATCH --job-name=pdptw_bench
#SBATCH --output=logs/pdptw_bench_%A_%a.out  # stdout log for each array task
#SBATCH --error=logs/pdptw_bench_%A_%a.err   # stderr log for each array task
#
...
INPUT_FILE="${PROJECT_DIR}/examples/lucia_input/input_lucia_pdptw_baseline.txt"
