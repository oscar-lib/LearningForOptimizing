#!/bin/bash
#
#SBATCH --job-name=irace_tuning_pdptw_u
#SBATCH --output=logs/irace_tuning_pdptw_ucb.out  # stdout log for the task
#SBATCH --error=logs/irace_tuning_pdptw_ucb.err   # stderr log for the task
#
#SBATCH --ntasks=1
